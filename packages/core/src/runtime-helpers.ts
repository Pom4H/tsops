 ...
 */
export interface SimplifiedRuntimeConfig<TConfig extends TsOpsConfig<any, any, any, any, any, any, any>> {
  /** Current namespace */
  namespace: Extract<keyof TConfig['namespaces'], string>
  /** Project name */
  project: TConfig['project']
 ...
 */
export function createSimplifiedRuntimeConfig<TConfig extends TsOpsConfig<any, any, any, any, any, any, any>>(
  config: TConfig,
  namespace: Extract<keyof TConfig['namespaces'], string>
): SimplifiedRuntimeConfig<TConfig> {
