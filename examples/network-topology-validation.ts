/**
 * Examples showing network topology validation at compile time
 * TypeScript will catch dependency errors before runtime
 */

import { defineConfigV2 } from '@tsops/core/config/v2'

// ✅ VALID CONFIGURATION - All dependencies exist and match ports/protocols
export const validConfig = defineConfigV2({
  project: 'hyper-graph',
...
export const invalidConfig = defineConfigV2({
  project: 'hyper-graph',
...
export const complexValidConfig = defineConfigV2({
...
export const mixedProtocolConfig = defineConfigV2({
  project: 'hybrid-app',
