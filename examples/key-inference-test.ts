/**
 * Test key inference with proper TypeScript narrowing
 */
  ...
  services: ({ domain, debug, logLevel, net, expose, res, depends }) => {
    ...
    return {
      ...
      web: {
        ...
        needs: [
          depends.on('api', 8080) // ✅ Should work - 'api' exists and is properly typed
        ] as const,
        resources: res.smol,
      ...
      worker: {
        ...
        needs: [
          ...
          depends.on('web', 80)    // ✅ Should work - 'web' exists
        ] as const,
