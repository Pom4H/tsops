      ...
      spec: {
        containers: Array<{
          ...
          env?: Array<
            ...
            | { name: string; valueFrom: Record<string, unknown> }
          >;
        }>;
      };
    };
...
export interface TsOpsConfigHelpers {
  ...
  buildImageTag?: (service: ServiceConfig & { name: string }, environment: EnvironmentConfig & { name: string }, git: GitInfo) => string;
}
